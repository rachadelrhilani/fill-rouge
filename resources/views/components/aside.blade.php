<aside class="w-64 bg-[#1E3A8A] min-h-screen flex flex-col font-body">
    ...
    <nav class="flex-grow px-4 space-y-2">
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 text-blue-100 rounded-xl font-display text-sm transition {{ request()->routeIs('admin.dashboard') ? 'text-white bg-white/10' : 'text-blue-100 hover:bg-white/5' }}"">
        ...
        @if(Auth::user()->role === 'admin')
            ...
            <a href="{{ route('admin.configuration') }}" class="flex items-center gap-3 px-4 py-3 text-blue-100 hover:bg-white/5 rounded-xl font-display text-sm transition {{ request()->routeIs('admin.configuration') ? 'text-white bg-white/10' : 'text-blue-100 hover:bg-white/5' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
